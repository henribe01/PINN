...
4. **Training**: We train the PINN using the Adam optimizer for a certain number of iterations. During training, we monitor the loss and the predicted viscosity $\nu$.
